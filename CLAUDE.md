...
🔧 Testes: test/task_series_utils_test.dart (10 casos, inclui o mês curto do 31/01), test/offline_store_test.dart (I/O real do cache offline), test/profile_name_test.dart, test/chip_contrast_test.dart, test/login_layout_test.dart test/task_status_test.dart, test/task_series_group_test.dart, test/compliance_utils_test.dart, test/chip_render_audit_test.dart, test/roteiro_offline_test.dart e test/roteiro_offline_fluxo_test.dart (roteiros offline passo a passo), test/app_filter_chip_test.dart, test/pdf_glifos_test.dart e test/l10n_test.dart — 115 no total. Cobertura ainda parcial: o grosso das telas continua sem teste