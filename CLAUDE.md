...
🔧 Testes: test/task_series_utils_test.dart (10 casos, inclui o mês curto do 31/01), test/offline_store_test.dart (I/O real do cache offline), test/profile_name_test.dart, test/chip_contrast_test.dart, test/login_layout_test.dart e test/l10n_test.dart — 47 no total. Cobertura ainda parcial: o grosso das telas continua sem teste